...
//       }
//     render() {
//         const { CreateAt, GeneralGoal, Message, NumberOfII, SpecificGoal, Vision, Logo } =this.props.data
// console.log(this.props);
//         return (
//             <div>
//                    <div className="modalContainer">
//                         <form className='login-form' onSubmit={e => this.props.handelSubmit(e)}>
...
//                                     value={CreateAt} />
//                             </div>
//                             <input className='lf--submit' type='submit' value='تسجيل الدخول' onSubmit={e => this.props.handelSubmit(e)} onClick={e => this.props.toggleHandler(e) , e => this.props.handelSubmit(e)} />
//                         </form>
//                     </div>
//             </div>
//         )
